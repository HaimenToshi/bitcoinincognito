...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1525691571, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // XBI: Retargeting
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("06c10e83b2703ccf322f7dbd62dd5855ac7c10bd055814ce121ba32607d573b8810c02c0582aed05b4deb9c4b77b26d92428c61256cd42774babea0a073b2ed0c9") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1525691571;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 430563;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // XBI: 1 day
        nTargetSpacing = 1 * 60;        // XBI: 1 minutes
